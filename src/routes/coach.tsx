...
const elaraReplies = [
  "Какое чудесное наблюдение. В следующий раз, когда Мартин потянется к игрушке, попробуйте пятисекундную паузу — отсчитайте её про себя. А затем назовите игрушку одним подчёркнутым словом.",
