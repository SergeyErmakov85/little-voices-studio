...
export const Route = createFileRoute("/world")({
  head: () => ({
    meta: [
      { title: "Волшебный мир Мартина — Lumina" },
      {
        name: "description",
        content:
          "Спокойная кинематографичная игровая сцена, синхронизированная с настоящими игрушками Мартина. Коснитесь светлячка, чтобы оживить одно тёплое, выделенное голосом слово.",
      },
      { property: "og:title", content: "Волшебный мир Мартина" },
        ...
        <div className="mt-8 grid grid-cols-1 gap-4 md:grid-cols-3">
          <div className="lumina-card p-6">
            ...
            <p className="text-sm text-warm-mist/65 leading-relaxed">
              Сядь рядом с Мартином, а не напротив планшета. Дай ему коснуться. Когда появится карточка со словом — произнеси его медленно, дважды, и посмотри на настоящую игрушку у него в руках.
            </p>
          </div>
          <div className="lumina-card p-6">
